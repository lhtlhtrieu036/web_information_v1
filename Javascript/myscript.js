...
headFactors.insertAdjacentHTML(
  "beforeend",
...
function maskCreator(e) {
  e.classList.add("boxMask"),
    (e.innerHTML =
      '<div class="text" style="opacity: 0;">' + e.innerHTML + "</div>"),
...
maskCreator(document.querySelector(".abm")),
  maskCreator(document.querySelector(".update"));
...
(getAvatarImg.style.opacity = "0"),
  (getAvatar.style.transformOrigin = "50% 50%"),
  theTime.add({
    targets: getAvatar,
    rotate: 340,
...
(getVerifyDiv.style.transformOrigin = "50% 0%"),
  (getVerifyDiv.style.transform = "scaleY(0)"),
  theTime.add({
...
charming(getFullName),
  (getFullName.style.transformOrigin = "50% 50%"),
  theTime.add({
    targets: ".name span",
    scaleY: [0, 1],
    translateY: [10, 0],
...
function maskCreatorVer2(e) {
  e.classList.add("boxMask"),
    (e.innerHTML = '<div class="text">' + e.innerHTML + "</div>"),
    e.insertAdjacentHTML(
      "beforeend",
      '<div class="mask"> <div class="mask1"></div> <svg id="Layer_1" class="mask2" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 338.26 204"><defs><style>.cls-1{fill:#4285f4;}</style></defs><path class="cls-1" d="M2.12,18.93V188.05a17.44,17.44,0,0,0,17.44,17.44H300.19c16.61,0,23.82-21,10.69-31.22h0a17.44,17.44,0,0,1,0-27.56l22.75-17.65a17.45,17.45,0,0,0,.2-27.4L308.14,81.11a17.44,17.44,0,0,1-4-22.74L315.38,40.1a17.44,17.44,0,0,0-3.44-22.3L298,5.75a17.41,17.41,0,0,0-11.42-4.26h-267A17.44,17.44,0,0,0,2.12,18.93Z" transform="translate(-2.12 -1.49)"/></svg> </div>'
    );
...
fw400(getJobh4),
  ...
  fw400(getContacth4),
  des(getContacth4),
  scaleContent(document.querySelector("hr")),
  scaleContent(document.querySelector(".job_content")),
  scaleContent(document.querySelector(".contact_content")),
  monitor(document.querySelector(".ctcme")),
  monitor(document.querySelector(".ms")),
  monitor(document.querySelector(".planet"));
var vichy = document.querySelector(".motivation");
function maskImgMonitor(e) {
  (e.innerHTML = '<div class="content">' + e.innerHTML + "</div>"),
    e.classList.add("boxMask"),
    e.insertAdjacentHTML(
      "beforeend",
      '<div class="mask"><div class="maskImage"></div></div>'
    );
  var t = e.querySelector(".mask");
  (t.style.transformOrigin = "100% 50%"), (t.style.transform = "scaleX(0)");
...
(vichy.innerHTML = "Motivation-" + vichy.innerHTML),
  maskImgMonitor(document.querySelector(".img1")),
  maskImgMonitor(document.querySelector(".img2"));
...
planet.addEventListener("mouseenter", function () {
  ...
  monitor(document.querySelector(".ulong")),
  monitor(document.querySelector(".ulang"));
